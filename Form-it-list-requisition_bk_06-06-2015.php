	...
	<form class="form-horizontal " id="Form_printing" name="Form_printing" action="index.php?Menu=IT-Flow-Requisition" method="post">
        ...
        <!--
			<div class="form-group" align="center">
				<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="Company">Employee Type / <span class="cssTH">ประเภทพนักงาน</span>:</label>
...
//alert(str);
  if (str=="") {
    document.getElementById("Form_printing").readOnly=true;
    return;
  } else
  {
	  document.getElementById("Form_printing").readOnly=false;
	  if(document.getElementById("EmpType").value=="New")
	  {
		 document.getElementById("CHK_IT1").checked=true; 
		 document.getElementById("CHK_IT1").readOnly=true;
	  }else
	  {
		 document.getElementById("CHK_IT1").checked=false; 
		 document.getElementById("CHK_IT1").readOnly=false;
	  }
  }
