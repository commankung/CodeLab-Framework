...
$strFile ="select DISTINCT FILE_NAME FROM TBL_APR_856 ";
...
$fromname = 'APR Ford MMOG System ';
$subject = 'APR Ford Automatic ASN Confirm : '.$File_Name;
$message = '<dt>Dear All,</dt> </br>';
$message .= '     Scan barcode for check parts delivery successfully.</br>     Please access to ford broadcast system for download confirm data file 856 : '.$File_Name;
$pathFile ='File_856/'.$File_Name;
// Main code
