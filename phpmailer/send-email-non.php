...
$subject = 'APR Ford Non Sequence Order Automatic ASN Confirm : '.$fileNameMul;
$message = '<dt>Dear All</dt> </br>';
$message .= '     Scan barcode for check parts delivery successfully.</br>     Please access to ford broadcast system for download confirm data file 856 : <br/>'.$fileNameMul;
// Main code
