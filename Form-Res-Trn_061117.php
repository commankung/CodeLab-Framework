                                  ...
                                  <div class="form">
                                      ...
                                      <form class="form-horizontal" id="frm1" name="form" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-md-7">
                                              <input type="text" class="form-control" name="emrg" id="emrg" placeholder="E-mail ผู้จัดการ/หัวหน้า"> 
                                            </div>
                                            * E-mail
                                          </div>
                                          ...
                                          <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-md-7">
                                              <input type="text" class="form-control input-mask-phone" name="Mobile_Emp" id="Mobile_Emp">
                                            </div>
                                          </div>
