...
<div id="display-list-course"></div>                                                    
 ...
 <div id="modal-add" class="modal fade" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" style="margin-top:0px;padding-top:10px;width:100%">
									...
									<div class="form-group" style="margin-bottom:5px;">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Scores </label>

										<div class="col-sm-9">
											<input type="text" id="scores_add" name="scores_add" class="col-xs-10 col-sm-10"  placeholder="ตัวอย่าง: 30/50 (เกณฑ์ผ่าน/คะแนนเต็ม) - กรณีไม่มีให้ว่างไว้" maxlength="10" style="font-family:Verdana, Geneva, sans-serif; font-size:13px; font-weight:normal;" />
										</div>
									</div>									
 ...
 <select class="col-xs-10 col-sm-10" id="Tbranch" name="Tbranch" onChange="showHideOther();">
                        ...
                        <option value="OTHER">OTHER</option>
                             ...
                             <!-- Other-->       
							<div id="d_other" style="display:none;margin-bottom:5px;">
                                    ...
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Upload Banner </label>
										<div class="col-sm-4">
											<input type="file" name="banner" id="id-input-file-1" class="form-control" style="width:312px;"/>
										</div>
										<font color="red">*ชื่อไฟล์ห้ามมี (<b>.</b>) - แสดงหน้า Intranet</font>
									</div>
									
									<div class="form-group" style="margin-bottom:0px;">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ภาพแรก Poster </label>
										<div class="col-sm-4">
											<input type="file" name="file" id="id-input-file-2" class="form-control" style="width:312px;"/>
										</div>
										<font color="red">*ชื่อไฟล์ห้ามมี (<b>.</b>) - แสดงหน้ารายละเอียด</font>
									</div>
									
									<div class="form-group" style="margin-bottom:0px;">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ภาพหลัง Poster </label>
										<div class="col-sm-4">
											<input type="file" name="file2" id="id-input-file-3" class="form-control" style="width:312px;"/>
										</div>
										<font color="red">*ชื่อไฟล์ห้ามมี (<b>.</b>) - แสดงหน้ารายละเอียด</font>
									</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="margin-top:0px;padding-top:10px;width:100%">
									...
									<div class="form-group" style="margin-bottom:5px;">
										...
										<div class="col-sm-9">
											<input type="text" id="scores_edit" name="scores_edit" class="col-xs-10 col-sm-10"  placeholder="ตัวอย่าง: 30/50 (เกณฑ์ผ่าน/คะแนนเต็ม) - กรณีไม่มีให้ว่างไว้" maxlength="10" style="font-family:Verdana, Geneva, sans-serif; font-size:13px; font-weight:normal;" />
										</div>
									</div>									
 ...
 <select class="col-xs-10 col-sm-10" id="Tbranch1" name="Tbranch1"  onChange="showHideOther1();">
                        ...
                        <option value="OTHER">OTHER</option>
                             ...
                             <!-- Other-->       
							<div id="d_other1" style="display:none;margin-bottom:5px;">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Other Detail </label>
										<div class="col-sm-9">
...
function chkFieldadd(){ 
 var ret = true;
	...
	}else if(document.getElementById("id-input-file-2").value == "" && document.getElementById("id-input-file-3").value == ""){
		ret = false;
