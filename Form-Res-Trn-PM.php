 ...
 <!--
                                          ...
                                          <h6 class="title" style="color:#0065a9;"><i class="icon-search"></i> Search by Employee ID or User ID</h6>  
                                            ...
                                            <div class="col-md-9">
                                              <input type="text" class="form-control" id="Emp_ID_S" name="Emp_ID_S" placeholder="Example: 10000960" onkeyup="">
											  <input type="hidden" class="form-control" id="CourseID_S" name="CourseID_S" value="<?php echo $CID;?>" onchange="">
                                            </div>
                  ...
                  <div class="formy well" style="background-color:#f2dede; border-color:#d4a0a8; margin-top:5px;">
                     <h4 class="title"><i class="icon-edit"></i> Registration for Course Training</h4>
                                  <div class="form">
                                      <!-- Register form (not working)-->
                                      <form style="visibility: hidden;" class="form-horizontal" id="frm1" name="form" enctype="multipart/form-data">
